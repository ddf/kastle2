...
namespace vessl
{
    ...
    namespace math
    {
        ...
        template<>
        inline q31_t cos<q31_t, phase_t>(phase_t p) { return kastle2::q31_sine(wrap01(p + PHASE_90).v_); }
    }
    ...
    namespace easing
    {
        ...
        { 
            ...
            q31_t dt = kastle2::q31_mult(kastle2::q31_sub(end, begin), t.v_);
            return kastle2::q31_add(begin, dt);
        }
